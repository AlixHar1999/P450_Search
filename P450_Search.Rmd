...
write_csv(proteinlist, file = "~/Bacteria filter list/1_P450_search/Proteins_P450/P450.csv")
```
...
```{r}
fastafile <- read_faa(file = "~/Bacteria filter list/1_P450_search/P450_proteins.fasta") %>% separate(seq_name, into = c("Protein_product"), sep = " ")

fastafile

write_csv(fastafile, file = "~/Bacteria filter list/1_P450_search/Proteins_P450/P450_fasta.csv")
```
...
write_csv(finaldata, file = "~/Bacteria filter list/1_P450_search/Proteins_P450/P450_final.csv")
```
